...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private GameObject LoseCamera;
    ...
    void Start()
    {
        ...
        skinIndex = PlayerPrefs.GetInt("chosenSkin");
        coins = PlayerPrefs.GetInt("coins");
        coinsText.text = coins.ToString(); 
        playerSkin.GetComponent<SkinnedMeshRenderer>().material = skins[skinIndex].material;
    ...
    private void OnControllerColliderHit(ControllerColliderHit hit)
    {
        if (hit.gameObject.tag == "obstacle")
        {
            ...
            else
            {
                ...
                LoseCamera.GetComponent<LosePanel>().SetRecord();
